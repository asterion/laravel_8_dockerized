...
class   Contact   extends    Model {use HasFactory;

public $table="contacts"; public $timestamps=true;  protected $fillable=['nickname','fullname','email','phone','address','active','status'];
...
public function getFullName( $prefix ){
    ...
    public function isActive( ):Bool { return $this->active; } // 👈 Code style: mal indentado, tipo de retorno en mayúsculas
